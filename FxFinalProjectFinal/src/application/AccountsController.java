	...
	public void createAcc(ActionEvent event) {
		if(current.isSelected()) {
			...
			try {
				...
				msgLabel.setText("Initial balance cannot be string(Alphabets). Try again with number");
			}
			...
			listV.getItems().addAll(accNum);
				...
				msgLabel.setText("Initial balance or withdraw limit cannot be string(Alphabets). Try again with number");
			}
